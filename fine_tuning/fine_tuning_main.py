...
from src.model.model_pretained_self import MMGNet
...
def load_config():
    ...
    args = parser.parse_args(['--config', '/home/honsen/honsen/SceneGraph/baseline/config/mmgnet_pretrain.json', '--mode',
                              'train','--exp','/home/honsen/tartan/msg_data/pointTrans1'])
